...
class _AlumnosPageState extends State<AlumnosPage> {
  ...
  void _onItemTapped(int index) {
    ...
    if (index == 0) {
      Navigator.popUntil(context, (route) => route.isFirst); // Ir al Home
    } else if (index == 1) {
      Navigator.pushNamed(context, '/loadData'); // Asegúrate de definir esta ruta
    }
  }
